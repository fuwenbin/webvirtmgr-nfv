...
def networks(request, host_id):
    ...
    try:
        ...
        config_file_info = util.get_data_from_file()
        ipaddr, gateway = util.get_config(config_file_info)
            ...
            if 'create' in request.POST:
                ...
                if form.is_valid():
                    ...
                    try:
                        ...
                        util.replace_config(config_file_info, data['ipaddr'], data['gateway'])
                    except:
                        msg = _("Set Managememt Config error")
                        errors.append(msg)
                    if not errors:
                        ...
                        util.reload_network(gateway, data['gateway'])
